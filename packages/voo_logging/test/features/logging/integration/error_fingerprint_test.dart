...
''',
    ...
    test('should track error severity correctly', () async {
      ...
      syncService.queueLog(LogEntry(
        ...
        level: LogLevel.error,
        metadata: const {
          'error_type': 'NetworkImageException',
          'is_fatal': false,
          'severity': 'low',
        },
      ));
    ...
    test('should handle errors with long stack traces', () async {
      ...
      // Long stack trace
      final longStackTrace = List.generate(50, (i) =>
        'at package:my_app/file_$i.dart:${i * 10}:${i * 2}'
      ).join('\n');
