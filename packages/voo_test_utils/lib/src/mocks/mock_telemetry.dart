...
class SpanFactory {
  ...
  static Span createWithAttributes({
    String name = 'test-span',
    SpanKind kind = SpanKind.internal,
  ...
  static Span createDatabase({
    String operation = 'SELECT',
    String table = 'users',
    String dbSystem = 'sqlite',
  }) {
    final span = Span(
...
class LogRecordFactory {
  ...
  static LogRecord createError({
    ...
    return LogRecord(
      ...
      severityText: 'ERROR',
      attributes: {
        if (exceptionType != null) 'exception.type': exceptionType,
...
class MetricFactory {
  ...
  static CounterMetric createCounter({
  ...
  static GaugeMetric createGauge({
...
class TelemetryConfigFactory {
  ...
  static TelemetryConfig createDebug({
    String endpoint = 'https://telemetry.test.com',
    String? apiKey = 'test-api-key',
  }) =>
      TelemetryConfig(
